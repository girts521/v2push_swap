...
/*   Updated: 2025/03/03 15:36:35 by gikarcev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	r_both(t_list **a, t_list **b, t_instructions **instructions, \
...
void	rr_both(t_list **a, t_list **b, t_instructions **instructions, \
				t_list *cheapest_node)
{
	while (*a != cheapest_node->target_node && *b != cheapest_node)
...
void	finish_rotation(t_list **a, t_list **b, t_instructions **instructions, \
						t_list *target)
{
